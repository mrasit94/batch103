...
public class E01 {
    /*1)"Exception" (istisnai hata) javada kodlarimizi calistirirken meydana
    gelen beklenmedik durumlardir.
      2) Exception lar ile calismanin iki yolu vardir
            ...
            b) throw exception kullanarak calismayi durdurma (mesela yazdigimiz
            kod geregi bir dosya uzerinden okuma yapmamız
            gerekiyor ise bu dosyamız eger silinmis ise java dosyayi bulamaz ve
            uygulanın devam etmesi gerekmez)
      ...
      try-catch block iciene koymalisiniz
      ...
      8) e.getmessage(), methodunu kullanarak teknik mesajlar elde edebiliriz.
         ...
         e.printStackTrace(); methodu Exception ile ilgili detaylica teknik mesaj verir.
         kod calismaya devam eder
         System.err.println("burasi renkli"); hata mesajini renkli olarak verir
         bu sayede cansolda diger mesajlardan ayırmak icin kullaniriz
...
//java matematik ile ilgili karsılasılması muhtemel tum istisnalari,
// hatalari ArithmeticException class'ina koymustur.
