...
public class Exceptions01 {
    ...
    //Verilen iki String'den birinin karakter sayisinin digerinin kac kati
    ...
    /*
       ...
       1)"final" bir keyword'dur. Variable, Class, ve Method'lar icin
       kullanilir.
        ...
        ii)Method'larda kullanilabilir.
           ...
           a)Bir method olusturulurken "final" olarak olusturulmus ise
             o methodun body'si asla degistirilemez. Dolayisiyla o method
             override edilemez.
        ...
        2)"finally" bir "code block" dur.
          ...
          Mesela Database ile connection'i kesmek herhalukarda yapilmasi gereken
          bir fiildir. Bunu "finally" ile yapabiliriz.
        3)"finalize" bir method'dur. Bu method Java tarafindan data'lar
        imha edilmeden once cagrilir, bu method data'lari
          imha edilecek hale getirir ve daha sonra "Garbage Collector"
          bu data'lari imha eder.
          "finalize" method'unu Java Developer'lar da cagirabilir ama
          Java kendi bildigini yapar.
     */
}
